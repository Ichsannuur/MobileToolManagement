...
public class TransaksiBarangKeluar extends AppCompatActivity {

    protected Cursor cursor;
    DB_helper dbcenter;
    EditText search;
    public static TransaksiBarangKeluar ad;
    ListView listView;
    String [] listBarang;
    int [] listId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaksi_barang_keluar);
    ...
    public void showList(){
        ...
        cursor = db.rawQuery("SELECT * FROM tbl_barang WHERE stok != 0",null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(TransaksiBarangKeluar.this);
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item){
                            case 0 :
                                ...
                                i.putExtra("barang_keluar", selection);
                                startActivity(i);
                                finish();
                                break;
    ...
    public void showListSearch(String cari){
        SQLiteDatabase db = dbcenter.getReadableDatabase();
        cursor = db.rawQuery("SELECT * FROM tbl_barang WHERE stok != 0 AND nama_barang LIKE '%"+cari+"%'",null);
        listBarang = new String[cursor.getCount()];
        listId = new int[cursor.getCount()];
        cursor.moveToFirst();
