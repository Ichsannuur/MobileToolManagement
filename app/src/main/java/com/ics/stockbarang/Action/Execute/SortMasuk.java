...
public class SortMasuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sort_masuk);
        getSupportActionBar().setTitle("Manager Report");
        getSupportActionBar().setSubtitle("Laporan Barang Masuk");
        ...
        tanggalAwal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(SortMasuk.this, date, myCalendar
        ...
        tanggalAkhir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(SortMasuk.this, date2, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
            ...
            public void onClick(View v) {
                if(tanggalAwal.getText().toString().equals("")){
                    ...
                    if (tangwal > tanghir) {
                        ...
                        SharedPreferences preferences = getSharedPreferences("report_masuk",MODE_PRIVATE);
                        SharedPreferences.Editor editor = preferences.edit();
                        editor.putString("tanggal_awal",tanggalAwal.getText().toString());
                        editor.putString("tanggal_akhir",tanggalAkhir.getText().toString());
                        editor.apply();

                        Intent i = new Intent(SortMasuk.this, ReportMasuk.class);
                        startActivity(i);
                        tanggalAwal.setText("");
