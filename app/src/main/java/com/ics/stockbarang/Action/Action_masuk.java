...
import com.ics.stockbarang.Action.Execute.Add_masuk;
import com.ics.stockbarang.Action.Execute.Show_barang;
import com.ics.stockbarang.Action.Execute.Show_masuk;
import com.ics.stockbarang.Connection.DB_helper;
import com.ics.stockbarang.R;

public class Action_masuk extends AppCompatActivity {

    protected Cursor cursor;
    Button fab;
    DB_helper dbcenter;
    public static Action_masuk am;
    ListView listView;
    String [] listBrng;
    int [] listId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_action_masuk);
    ...
    public void showList(){
        ...
        cursor = db.rawQuery("SELECT * FROM tbl_masuk ORDER BY id_transaksi DESC",null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Action_masuk.this);
